...
const PrivacySection = () => {
    return (
        <div className="privacy-section">
            <label className="title">Privacy Policy</label>
            <div className="privacy-sub-section">
                <label className="sub-title">User Data</label>
                <p>
            ...
            <div className="privacy-sub-section">
                <label className="sub-title">3rd Party Services</label>
                <p>
            ...
            <div className="privacy-sub-section">
                <label className="sub-title">Good Vibes Preserver Server</label>
                <p>
