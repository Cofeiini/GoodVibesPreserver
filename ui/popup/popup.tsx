...
const PowerButton = () => {
    ...
    return (
        <div className="gvp-power-button-container">
            <label>Toggle Extension</label>
        ...
        <>
            <main className="gvp-popup-main">
                ...
                <section className="gvp-popup-content">
                    <div className="gvp-popup-buttons">
                        <PowerButton/>
                        <DisableOnWebsite/>
                    </div>
                    ...
                    <section className="gvp-popup-links">
                        ...
                        <div>
                            <a href="" onClick={() => {
                                browser.tabs.create({ url: "../options/options.html?section=Privacy" });
                            }}>Privacy</a>
                        </div>
                        <div>
                            <a href="" onClick={() => {
                                browser.tabs.create({ url: "../options/options.html?section=Help" });
                            }}>Help</a>
                        </div>
                    </section>
                </section>
